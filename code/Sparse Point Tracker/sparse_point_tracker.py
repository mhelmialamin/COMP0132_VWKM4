...
#
#  Edited and Tested by : Muhammad Helmi Al Amin
#  Student Number       : 20110211
#  Candidate Number     : VWKM4
#  MSc Robotics and Computation | University College London
#
# %AUTHORS_END%
# --------------------------------------------------------------------*/
# %BANNER_END%
...
if __name__ == '__main__':
  ...
  parser.add_argument('--weights_path', type=str, default='superPointNet_170000_bestCOCO.pth.tar',
      help='Path to pretrained weights file (default: superPointNet_170000_bestCOCO.pth.tar).')
